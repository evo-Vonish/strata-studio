...
export const propertyDefinitions: PropertyDefinition[] = [
  ...
  style("backgroundImage", "Background image", "asset", "asset"),
  ...
  attribute("tag", "Semantic tag", "enum", "select", ["Box", "Text"]),
  {
    id: "textContent",
    label: "Text",
    group: "Content",
  ...
  attribute("buttonType", "Button type", "enum", "select", ["Button"]),
  attribute("disabled", "Disabled", "boolean", "toggle", ["Button", "Input"]),
  attribute("imageSource", "Source", "asset", "asset", ["Image"]),
  ...
  attribute("fetchPriority", "Fetch priority", "enum", "select", ["Image"]),
  attribute("inputType", "Input type", "enum", "select", ["Input"]),
  ...
  {
    ...attribute("readOnly", "Read only", "boolean", "toggle", ["Input"]),
  ...
  {
    ...attribute("minLength", "Minimum length", "number", "number", ["Input"]),
    visibleWhen: { property: "inputType", oneOf: textInputTypes },
  },
  {
    ...attribute("maxLength", "Maximum length", "number", "number", ["Input"]),
    visibleWhen: { property: "inputType", oneOf: textInputTypes },
  },
  {
